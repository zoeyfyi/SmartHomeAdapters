...
func (*RobotsQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_infoserver_9e3af723a98a1613, []int{0}
}
...
func (*RobotQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_infoserver_9e3af723a98a1613, []int{1}
}
...
func (*RegisterRobotQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_infoserver_9e3af723a98a1613, []int{2}
}
...
func (*ToggleRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_infoserver_9e3af723a98a1613, []int{3}
}
...
func (*RangeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_infoserver_9e3af723a98a1613, []int{4}
}
...
func (*Robot) Descriptor() ([]byte, []int) {
	return fileDescriptor_infoserver_9e3af723a98a1613, []int{5}
}
...
func (*ToggleStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_infoserver_9e3af723a98a1613, []int{6}
}
...
func (*RangeStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_infoserver_9e3af723a98a1613, []int{7}
}
...
func (*CalibrationRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_infoserver_9e3af723a98a1613, []int{8}
}
...
func (*CalibrationParameter) Descriptor() ([]byte, []int) {
	return fileDescriptor_infoserver_9e3af723a98a1613, []int{9}
}
...
func (*CalibrationParameters) Descriptor() ([]byte, []int) {
	return fileDescriptor_infoserver_9e3af723a98a1613, []int{10}
}
...
func (*SetUsecaseRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_infoserver_9e3af723a98a1613, []int{11}
}
...
func (*RenameRobotRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_infoserver_9e3af723a98a1613, []int{12}
}
...
func (*Usecase) Descriptor() ([]byte, []int) {
	return fileDescriptor_infoserver_9e3af723a98a1613, []int{13}
}
...
func init() {
	proto.RegisterFile("infoserver/infoserver.proto", fileDescriptor_infoserver_9e3af723a98a1613)
}

var fileDescriptor_infoserver_9e3af723a98a1613 = []byte{
	// 698 bytes of a gzipped FileDescriptorProto
	,
}
